...
class DolphinProfile {
        ...
        try {
            await page.evaluateOnNewDocument(() => {
                ...
                const automationFlags = [
                    ...
                    '__fxdriver_evaluate', '__webdriver_script_fn', '__$webdriverAsyncExecutor'
                ];
            ...
            logger.info('Anti-detection scripts injected successfully (Dolphin)');
        } catch (error) {
            logger.warn('Failed to inject anti-detection scripts (Dolphin)', { error: error.message });
        }
    }
    ...
    async getPage() {
        if (!this.page) {
            ...
            // Inject anti-detection on new page
            await this.injectAntiDetectionScripts(this.page);
        }
        return this.page;
    }
